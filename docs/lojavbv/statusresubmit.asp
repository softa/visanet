	...
	<table width="800" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	    <td width="141"><img src="Img/Barra_Lat_Esq.jpg" width="135" height="474"></td>
	    <td width="653" valign="top"><table width="100%" height="376">
          <tr>
          ...
          <tr>
            <td height="159"class="corpo">
              <p> <b>TIDMASTER=</b><%=request.form("tidmaster")%><br>
